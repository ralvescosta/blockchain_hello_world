...
type BlockChain struct {
	LastHash []byte
	Status   Status
	repo     interfaces.IBlockchainRepository
}
...
func blockchainAlreadyExist(address string, repo interfaces.IBlockchainRepository, lastBlock *pkgBlock.Block) (*BlockChain, error) {
	status := Status{Already: true}
	return &BlockChain{lastBlock.Hash, status, repo}, nil
}
func createNewBlockChain(address string, repo interfaces.IBlockchainRepository) (*BlockChain, error) {
...
func NewBlockchain(address string, repo interfaces.IBlockchainRepository) (*BlockChain, error) {
